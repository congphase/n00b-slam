//
// Created by phase on 07/05/2024.
//
...
int main(int argc, char** argv) {
  ...
  // class. Its first three parameters are: data type, row, column. Declare a
  // 2*3 float matrix
  ...
  // If you are not sure about the size of the matrix, you can you a matrix of
  // dynamic size
  Matrix<double, Dynamic, Dynamic> matrix_dynamic;
  // simpler
  MatrixXd matrix_x;
  // There are still many types of this kind. We don't list them one by ones.
  ...
  // We can easily multiply a matrix with a vector (but actually still
  ...
  // Usually solved by matrix decomposition, such as QR decomposition, the
